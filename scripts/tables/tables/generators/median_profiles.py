...
class MedianProfileInstructionEnergyTable:
    ...
    def generate(self):
        output_csv_path = self.result_directory / "instruction_medians_per_device.csv"
        merged_dataframe = self.generate_dataframe()
        merged_dataframe.to_csv(output_csv_path, index=False)

        output_tex_path = self.result_directory / "instruction_medians.tex"
