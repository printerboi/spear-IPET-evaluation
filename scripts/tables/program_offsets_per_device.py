...
offset_dataframe = pd.DataFrame(offset_rows)

output_csv_path = results_directory / "programoffset_per_device.csv"
...
column_format = "@{}llS[table-format=1.3e-2]S[table-format=1.3e-2]S[table-format=1.2]@{}"
...
output_tex_path = results_directory / "programoffset_per_device.tex"
